...
/**
 * Represents a basic implementation of a basic square Reversi Game. Implements the MutableReversi
...
public class SquareReversi extends AbstractReversi {
  ...
  /**
   * Used to create a square reversi game.
   * Creates a {@link SquareReversi} model game.
   *
